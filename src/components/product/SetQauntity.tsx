  ...
  return (
    <div className="flex items-center gap-8">
      ...
      <div className="flex items-center gap-2">
        <button
          disabled={Number(cartProduct?.quantity) >= Number(cartProduct?.stock)}
          className="border-[1.2px] rounded px-2 border-slate-300"
        ...
        <button
          disabled={Number(cartProduct?.quantity) <= 1}
          className="border-[1.2px] rounded px-2 border-slate-300"
